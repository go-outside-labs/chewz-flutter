...
import 'package:chewz/SwipeAnimation/dummyCard.dart';
import 'package:chewz/SwipeAnimation/activeCard.dart';
...
class CardDemoState extends State<CardDemo> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    double initialBottom = 5.0;
    var dataLength = data.length;
    double backCardPosition = initialBottom + (dataLength - 1) * 10 + 0;
